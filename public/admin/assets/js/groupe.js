$(document).ready(function() {
    ...
    function addRemoveButton($card) {
        ...
        var $removeButton = $('<a href="#" class="btn btn-icon btn-sm btn-danger supprimer" style="margin-left: -16px" data-card-tool="remove" data-toggle="tooltip"\n' +
            '           data-placement="top" title="" data-original-title="Remove Card"><i class="ki ki-close icon-nm"></i> </a>');
